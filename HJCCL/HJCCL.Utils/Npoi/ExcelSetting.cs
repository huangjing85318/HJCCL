...
namespace HJCCL.Utils.Npoi
{
    ...
    public class ExcelSetting
    {
        ...
        /// 获取或设置 公司名称
        /// </summary>
        public string Compnay { get; set; } = "hj";

        /// <summary>
        /// 获取或设置 作者
        /// </summary>
        public string Author { get; set; } = "hj";

        /// <summary>
        /// 获取或设置 主题
        /// </summary>
        public string Subject { get; set; } = "HJCCL.Utils.Npoi 扩展封装，提供IEnumerable<T>导出数据";
